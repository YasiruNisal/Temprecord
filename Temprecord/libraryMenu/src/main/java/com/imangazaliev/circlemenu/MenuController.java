        ...
        View.OnLongClickListener onButtonItemLongClickListener = new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (hintsEnabled) {
                    ...
                    //Toast.makeText(menuButton.getContext(), menuButton.getHintText(), LENGTH_SHORT).setGravity(Gravity.TOP| Gravity.LEFT, 0, 0);
                    Toast toast= Toast.makeText(menuButton.getContext(),
                            menuButton.getHintText(), Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.TOP|Gravity.CENTER_HORIZONTAL, 0, 155 );
                    toast.show();
                }
                return hintsEnabled;
            }
